...
<html>
<head>
	<title>Visitor Tag Creater</title>
  ...
  <script>
    $(document).ready(function()
    {
      ...
      {
        var values=$("#pid").val();
        $.post("patient_detail_visitor.php",{id:values},function(data)
        {
          $("#det").html(data).show();
        });
      });
	...
	<main>
		<div class="container">
            ...
            <div class="heading col-sm-12" style="border-top: none;">
              <h1><img src="../images/tag3.png" style="width: 100px;height: auto;" > Visitor Tag</h1>
            </div>
          </div>
