			...
			<div class="row">
				<div class="col-12 col-sm-12 col-md-12 col-lg-12 table-body">
					...
					<div class="row form-inline" >
						...
						<div class="col-6 col-sm-6 col-md-4 col-lg-3 form-group">
							<span class="label1">Department Name:</span>
						</div>	
					
						<div class="col-6 col-sm-6 col-md-2 col-lg-2 form-group">
	             	...
	             	?>
						...
						<div class="col-12 col-sm-12 col-md-5 col-lg-2 "></div>
					
						<div class="col-6 col-sm-6 col-md-4 col-lg-2 form-group">
				...
				<div class="row">
					<div class="col-sm-12">
						<div id="area">
							<?php
								$r=mysqli_query($con,"select id,app_date,app_time,patients.name,phno,doc_name,departments.name,status from patients inner join departments on department=dept_id");
								if($r)
								{
							?>
