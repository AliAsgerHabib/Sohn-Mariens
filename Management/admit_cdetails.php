    ...
    <div class="row">
      <div class="col-12 col-sm-12 col-md-12 col-lg-9 box-body">
        ...
        <div class="row">
              ...
              <div class="col-4 col-sm-7 col-md-6 col-lg-6">
        ...
        <div class="row">
          ...
          <div class="row">
              ...
              <div class="col-3 col-sm-7 col-md-3 col-lg-3">
               <?php  echo $rowx[3]; ?>
              </div>
          </div>
          ...
          <div class="row">
              ...
              <div class="col-6 col-sm-7 col-md-3 col-lg-3">
               <?php  echo $rowx[13];?>
              </div>
              <div class="col-4 col-sm-4 col-md-2 col-lg-3">
          ...
          <div class="row">
              ...
              <div class="col-4 col-sm-7 col-md-3 col-lg-3">
               <?php  echo $rowx[15]; ?>
              </div>
          </div>
          </br>
          ...
          <div class="row">
              ...
              <div class="col-4 col-sm-7 col-md-2 col-lg-3">
               <?php  echo $rowx[7]; ?>
              </div>
          </div>
