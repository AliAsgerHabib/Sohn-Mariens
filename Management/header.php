...
<div class="w3-sidebar w3-bar-block w3-border-right" style="display:none" id="mySidebar">
  ...
  <a href="employee_form.php" class="w3-bar-item w3-button"><i class="fas fa-user-plus"></i> &nbsp;Employee Registration</a>
  <a href="employee_details.php" class="w3-bar-item w3-button"><i class="fas fa-list-ul"></i> &nbsp;Employee Details</a>
  <a href="doctor_schedule.php" class="w3-bar-item w3-button"><i class="fas fa-calendar-alt"></i> &nbsp;Doctor Schedules</a>
